...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a class="brand-link">
                <img src="/dist/img/logo.png" alt="Logo" width="200" height="70">
                {{-- <span class="brand-text font-weight-light">Chingnautla</span> --}}
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a class="d-block"> <h3>User: {{ Auth::user()->name }}</h3></a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            <strong>Gestión de Ayuntamiento <a>2021-2024</a>.</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
